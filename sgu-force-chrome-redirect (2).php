...
/* Specific styling for emoji container in h1 */
h1 div {
margin-top: 0.2rem !important; /* Reduced gap */
margin-bottom: -0.3rem !important; /* Reduced gap */
font-size: 1.5rem;
}
...
margin: 0.3rem 0 1.5rem 0; /* Reduced top margin from 1.5rem to 0.3rem */
display: inline-flex;
align-items: center;
gap: 0.75rem;
min-width: 200px;
...
h1 {
font-size: 1.5rem;
margin-bottom: 0.2rem; /* Reduced for mobile too */
}
...
font-size: 1.1rem;
min-width: 180px;
margin: 0.2rem 0 1.5rem 0; /* Reduced for mobile */
}
}
</style>
</head>
  ...
  <form method="post" action="">
            ...
            <div style="background: #fff3cd; padding: 15px; border-left: 4px solid #ffc107; margin: 20px 0;">
                ...
                <ul>
                    ...
                    <li><strong>Reduced Gap:</strong> Tighter spacing between emoji and button for better mobile experience</li>
                </ul>
            </div>
